...
Cubey = (function() {
  ...
  Cubey.prototype.onWindowResize = function() {
  ...
  generateStars = function() {
    var colorValues, i, j, material, ref, star, starGeo, stars, xyz;
    ...
    for (i = j = 1, ref = numberOfStars; 1 <= ref ? j <= ref : j >= ref; i = 1 <= ref ? ++j : --j) {
      ...
      colorValues = (function() {
        ...
        results = [];
        for (i = k = 1; k <= 3; i = ++k) {
          results.push(Math.random() * 0.4 + 0.6);
        }
        return results;
      })();
      starGeo.vertices.push(star);
      starGeo.colors.push((function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(THREE.Color, colorValues, function(){}));
    }
  ...
  Cubey.prototype.render = function() {
    return this.renderer.render(this.scene, this.camera);
  };

  Cubey.prototype.renderLoop = function() {
    this.update();
